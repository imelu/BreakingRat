...
public class TraitSelector : MonoBehaviour
{
    ...
    public void SetTraits(GameObject Parent1Local, GameObject Parent2Local)
    {
        ...
        */
        ...
        bodyPartCounter = 0;
        SpriteManager.Instance.GenerateThingy(BodypartsOut[0], BodypartsOut[1], BodypartsOut[2], BodypartsOut[3], BodypartsOut[4], BodypartsOut[5], BodypartsOut[6], BodypartsOut[7], BodypartsOut[8], BodypartsOut[9], BodypartsOut[10], BodypartsOut[11], Parent1.transform.position, mainChildAnimalType);
